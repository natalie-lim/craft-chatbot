      ...
      <div className="flex flex-col items-center justify-center pt-48 px-6">
        ...
        <div className="flex flex-row flex-wrap gap-8 mt-24 p-4">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center rounded-xl h-48 w-48 bg-[#d1cfe2] opacity-90 hover:opacity-100 transition"
          >
          ...
          >
            ...
            <span className="text-white font-semibold text-lg">Negotiations</span>
          </button>
        </div>
      </div>
    </div>
